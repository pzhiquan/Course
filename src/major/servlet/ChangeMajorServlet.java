...
public class ChangeMajorServlet extends HttpServlet {
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Major major = CommonUtils.toBean(map,Major.class);//把Map中大部分数据封装到admin对象中
		//major.setMajorID(CommonUtils.uuid());
		MajorService majorService=new MajorService();
		majorService.change(major);
		//majorService.add(major);
		request.setAttribute("msg", "修改专业成功！");
		request.getRequestDispatcher("/MajorServlet?method=findAllB").forward(request, response);
